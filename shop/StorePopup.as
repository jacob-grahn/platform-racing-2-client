...
package shop
{
    ...
    public class StorePopup extends Popup 
    {
        ...
        private var itemSpacingX:int = 137;
        ...
        private function addListing(obj:Object):StoreListing
        {
            ...
            listing.x = (this.listings.length % this.itemsPerRow) * this.itemSpacingX;
            listing.y = Math.floor(this.listings.length / this.itemsPerRow) * this.itemSpacingY;
