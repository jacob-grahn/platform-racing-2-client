...
package character
{
    ...
    public class PhysicsParticle extends Sprite 
    {
        ...
        public function PhysicsParticle(_arg_1:Object)
        {
            this.setColor(_arg_1.colors);
            _arg_1.x = this.randRange(_arg_1.minX, _arg_1.maxX);
            _arg_1.y = this.randRange(_arg_1.minY, _arg_1.maxY);
            _arg_1.velX = this.randRange(_arg_1.minVelX, _arg_1.maxVelX);
            _arg_1.velY = this.randRange(_arg_1.minVelY, _arg_1.maxVelY);
            _arg_1.velAlpha = this.randRange(_arg_1.minVelAlpha, _arg_1.maxVelAlpha);
            _arg_1.velRotation = this.randRange(_arg_1.minVelRotation, _arg_1.maxVelRotation);
            _arg_1.scale = this.randRange(_arg_1.minScale, _arg_1.maxScale);
            _arg_1.rotation = this.randRange(_arg_1.minRotation, _arg_1.maxRotation);
            x = ((_arg_1.x) || (0));
            y = ((_arg_1.y) || (0));
            ...
            this.life = (this.maxLife = ((_arg_1.life) || (10)));
            this.targetAlpha = ((_arg_1.targetAlpha) || (1));
            this.curAlpha = (alpha = ((_arg_1.startAlpha) || (0)));
            ...
            addChild(this.makeGraphic(_arg_1.graphic));
        ...
        public function makeGraphic(_arg_1:String):DisplayObject
        {
        ...
        private function randRange(_arg_1:Number, _arg_2:Number):Number
        {
        ...
        private function onEnterFrame(_arg_1:Event)
        {
            ...
            this.curAlpha = (this.curAlpha + this.velAlpha);
            if (this.curAlpha > 1) {
                this.curAlpha = 1;
            }
            alpha = (this.curAlpha * (this.life / this.maxLife));
            this.life--;
            if (this.life <= 0) {
                this.remove();
            }
