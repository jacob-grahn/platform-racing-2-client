...
package package_6
{
    ...
    public class Game extends Course 
    {
        ...
        private function superBooster(arr:Array)
        {
            ...
            var _local_3:Character = var_40[_local_2];
            _local_3.method_576();
        }
        ...
        private function createLocalCharacter(_arg_1:Array)
        {
            ...
            var _local_18:Racer = new Racer(_local_2, this, blockBackground, miniMap.getDot(), itemDisplay, Number(gravity), _local_3, _local_4, _local_5, _local_10, _local_11, _local_12, _local_13);
            _local_18.setColors(_local_6, _local_14, _local_7, _local_15, _local_8, _local_16, _local_9, _local_17);
            var_40[_local_2] = _local_18;
