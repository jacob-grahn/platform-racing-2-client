#!/usr/bin/env python3
"""
Generate the archival Haxe source for the PR2 XFL asset graph catalog.

This is a one-time migration helper. It reads the Adobe-free XFL metadata
parser and writes compatibility-runtime data under haxe/legacy for parity tools.
Normal OpenFL builds do not add that directory to their class path.
"""
