...
class EditorBlockOptionsTest {
	...
	private static function testAuthoredSaveLevelView():Void {
		...
		assertNear(-73.45, heading.x, "save-level heading x");
		...
		assertNear(203.001403808594, title.controlWidth, "save-level title input width");
		...
		assertNear(203.0029296875, note.controlWidth, "save-level note width");
		assertNear(61, note.controlHeight, "save-level note height");
		...
		assertNear(-170.25, titleCount.x, "save-level title count x");
