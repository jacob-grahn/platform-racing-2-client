...
class LobbyServicesTest {
	...
	private static function testLevelEditorShell():Void {
		...
		var zoomSelect = Std.downcast(DisplayUtil.findByName(editor.menu.art, "zoomSelect"), GameSelect);
		...
		var undoButton = Std.downcast(DisplayUtil.findByName(editor.menu.art, "undoButton"), GameButton);
		var redoButton = Std.downcast(DisplayUtil.findByName(editor.menu.art, "redoButton"), GameButton);
		...
		assertEquals(0x555555, undoButton.labelField.getTextFormat().color, "disabled undo label remains readable");
		assertEquals(0x555555, redoButton.labelField.getTextFormat().color, "disabled redo label remains readable");
		...
		var itemOneCheck = Std.downcast(DisplayUtil.findByName(editor.activeBlockOptionsPopup.art, "check1"), GameCheckBox);
		var itemTwoCheck = Std.downcast(DisplayUtil.findByName(editor.activeBlockOptionsPopup.art, "check2"), GameCheckBox);
		var itemFourCheck = Std.downcast(DisplayUtil.findByName(editor.activeBlockOptionsPopup.art, "check4"), GameCheckBox);
		...
		itemBlock.getChildByName("optionsButton").dispatchEvent(new MouseEvent(MouseEvent.MOUSE_DOWN));
		itemTwoCheck = Std.downcast(DisplayUtil.findByName(editor.activeBlockOptionsPopup.art, "check2"), GameCheckBox);
		...
		var resetCheck = Std.downcast(DisplayUtil.findByName(editor.activeBlockOptionsPopup.art, "resetChk"), GameCheckBox);
		...
		resetCheck = Std.downcast(DisplayUtil.findByName(editor.activeBlockOptionsPopup.art, "resetChk"), GameCheckBox);
