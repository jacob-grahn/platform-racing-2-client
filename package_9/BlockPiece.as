...
// package_9.class_106 = package_9.BlockPiece
...
package package_9
{
    ...
    public class BlockPiece extends Effect 
    {
        ...
        public function BlockPiece(_arg_1:DisplayObject, _arg_2:Number=1, _arg_3:Number=0.95, _arg_4:Number=0.01, _arg_5:Number=10, _arg_6:Number=10, _arg_7:Number=10, _arg_8:Number=0, _arg_9:Number=0)
        {
            addChild(_arg_1);
            x = _arg_8;
            y = _arg_9;
