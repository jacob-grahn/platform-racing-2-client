...
package package_9
{
    ...
    public class LaserShot extends class_135 
    {

        private var m:LaserShotGraphic = new LaserShotGraphic();

        public function LaserShot(_arg_1:Number, _arg_2:Number, _arg_3:String, _arg_4:int, _arg_5:int)
        {
            var _local_6:Number = 0;
            if (_arg_3 == "left") {
                _local_6 = 180;
            }
            super(_arg_1, _arg_2, _local_6, _arg_4, _arg_5);
            method_62(29);
            addChild(this.m);
