...
package dialogs
{
    ...
    public class BanMenu extends Removable 
    {
        ...
        public function banUser()
        {
            ...
            this.uploading.addEventListener(SuperLoader.e, this.onBanError, false, 0, true);
        }

        private function onBanError(e:Event)
        {
        ...
        override public function remove()
        {
            ...
            if (this.uploading != null) {
                this.uploading.removeEventListener(SuperLoader.e, this.onBanError);
